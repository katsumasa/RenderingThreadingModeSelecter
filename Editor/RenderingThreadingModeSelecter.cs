...
namespace Utj
{
    ...
    /// "Edit/RenderingThreadingMode" からモードを切り替える事が出来ます。
    /// 
    ...
    public class RenderingThreadingModeSelector
    {
        ...
        {
            {UnityEngine.Rendering.RenderingThreadingMode.Direct,"Edit/RenderingThreadingMode/Direct" },
            {UnityEngine.Rendering.RenderingThreadingMode.MultiThreaded,"Edit/RenderingThreadingMode/MultiThreaded" },
            {UnityEngine.Rendering.RenderingThreadingMode.LegacyJobified,"Edit/RenderingThreadingMode/LegacyJobified" },
            {UnityEngine.Rendering.RenderingThreadingMode.NativeGraphicsJobs,"Edit/RenderingThreadingMode/NativeGraphicsJobs" },
            {UnityEngine.Rendering.RenderingThreadingMode.NativeGraphicsJobsWithoutRenderThread,"Edit/RenderingThreadingMode/NativeGraphicsJobsWithoutRenderThread" },
        };
        ...
        /// Directが選択された時の処理
        /// </summary>
        [MenuItem("Edit/RenderingThreadingMode/Direct", false)]
        ...
        [MenuItem("Edit/RenderingThreadingMode/Direct", true)]
        ...
        /// </summary>
        [MenuItem("Edit/RenderingThreadingMode/MultiThreaded", false)]
        ...
        [MenuItem("Edit/RenderingThreadingMode/MultiThreaded", true)]
        ...
        /// </summary>
        [MenuItem("Edit/RenderingThreadingMode/LegacyJobified", false)]
        ...
        /// </summary>
        [MenuItem("Edit/RenderingThreadingMode/NativeGraphicsJobs", false)]
        ...
        /// </summary>
        /// <returns></returns>
        [MenuItem("Edit/RenderingThreadingMode/NativeGraphicsJobs", true)]
        ...
        /// </summary>
        [MenuItem("Edit/RenderingThreadingMode/NativeGraphicsJobsWithoutRenderThread", false)]
        ...
        /// </summary>
        /// <returns>true:可能 false:不可能</returns>
        [MenuItem("Edit/RenderingThreadingMode/NativeGraphicsJobsWithoutRenderThread", true)]
